                ...
                <form method="post" action="/rooms" class="mb-5" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="description" required
                            class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 form-input focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300"></textarea>
                    </div>
                    ...
                    <div class="mb-4">
                        <label class="block text-sm text-gray-700 dark:text-gray-400">Gambar Kamar</label>
                    ...
                    <div class="flex items-center justify-end mt-4">
                        ...
                        <button type="button" id="closeModal"
                            class="px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-red-600 border border-transparent rounded-md active:bg-red-600 hover:bg-red-700 focus:outline-none focus:shadow-outline-red ml-2">
                            Tutup
                        </button>
                    </div>
                </form>
