...
@section('content')
    <section class="bg-white dark:bg-gray-900">
        <div id="home" class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
            ...
            <script>
                $(document).ready(function() {
                    ...
                    function updateHeading() {
                        ...
                        // Menambahkan 'di Kost Connect' hanya jika tidak ada filter
                        if (!genderText && !cityText) {
