        ...
        <div class="mx-auto max-w-screen-xl px-4 lg:px-0">
            <div class="mb-8">
                <nav class="flex" aria-label="Breadcrumb">
                    <ol class="inline-flex items-center space-x-2 rtl:space-x-reverse">
                        <li>
                            <a href="#"
                                class="text-gray-700 hover:text-primary-600 dark:text-gray-400 dark:hover:text-white flex items-center">
                        ...
                        <li>
                            ...
                            <a href="#"
                                class="text-gray-700 hover:text-primary-600 dark:text-gray-400 dark:hover:text-white">Kamar
                                Kost</a>
                        </li>
                        <li>
                            <span class="text-gray-500 dark:text-gray-400 mx-2">/</span>
            ...
            <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                @foreach ($rooms as $room)
                    <div
                        class="group rounded-lg border border-gray-200 bg-white shadow-lg transition-transform duration-300 hover:-translate-y-1 hover:shadow-2xl dark:border-gray-700 dark:bg-gray-800">
                        ...
                        @if ($room->house->gender_type == 'putra') bg-blue-100 text-blue-800 dark:bg-blue-900 dark:text-blue-300
