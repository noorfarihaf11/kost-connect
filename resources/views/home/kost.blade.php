        ...
        <section class="bg-gray-50 py-6 antialiased dark:bg-gray-900">
            ...
            <div class="mx-auto max-w-screen-xl px-4 lg:px-0">
                ...
                <div class="mb-8 flex items-center justify-between">
                    <h2 id="heading" class="mt-3 text-2xl font-bold text-gray-900 dark:text-white">Semua kost di Kost
                        Connect</h2>

                    <button id="filterToggle" type="button"
                        class="relative rounded bg-primary-700 px-5 py-2 text-sm font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                        Filter
                    </button>
                </div>
                                ...
                                <div class="mt-2 text-sm text-gray-500 dark:text-gray-400">
                                    <ul class="space-y-1">
                                        <li><span class="font-medium text-gray-700 dark:text-gray-300">Kamar
                                                Tersedia:</span> {{ $room->available_rooms ?? 'Tidak Tersedia' }} kamar
                                        </li>
