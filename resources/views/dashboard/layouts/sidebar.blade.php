                    ...
                    @if (Gate::allows('owner'))
                        ...
                        <li class="relative px-6 py-3">
                            <a href="/laporanpembayaran"
                               class="menu-item inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 {{ request()->is('laporanpembayaran') ? 'text-gray-800' : 'text-gray-600' }}">
